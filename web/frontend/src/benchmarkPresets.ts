...
export const BENCHMARK_PRESET_DEFS: BenchmarkPresetDef[] = [
  {
    ...
    label: "Ingest/Contribution Protocol Comparison",
    hint: "Laptop→cloud webcam or cloud→cloud VOD · SRT + RTMP + MoQ · ingest only (not glass)",
  ...
  {
    id: "cloud-compare",
    label: "Cloud/Infrastructure Comparison",
    hint: "Compare performance to various endpoints to determine the optimal infrastructure provider for your network path.",
    locks: ["testScope"],
    lockProtocolMix: true,
    lockEndpoints: false,
  ...
  {
    id: "webrtc-vs-moq",
    label: "MoQ vs WebRTC Realtime Comparison",
  ...
  {
    id: "protocol-compare",
    label: "End-to-End Protocol Comparison",
    hint: "4-way SRT + RTMP + WebRTC + MoQ :14433 · capture to glass",
    locks: ["testScope", "outputs"],
    lockedSummary: "This recipe locked: 4 outputs (SRT/RTMP/WHIP/MoQ :14433)",
  },
  {
    id: "build-your-own",
    label: "Custom - Build Your Own Comparison",
    hint: "choose your source, output configurations, endpoints and players.",
    locks: [],
    lockedSummary: "",
  },
];
